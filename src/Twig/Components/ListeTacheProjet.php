...
final class ListeTacheProjet
{
    ...
    public TacheProjetRepository $tacheNormaleRepository;
    public EntityManagerInterface $entityManager;
    
    public function __construct(TacheProjetRepository $tacheNormaleRepository, EntityManagerInterface $entity_manager){
